        ...
        <section className="flex flex-row flex-wrap justify-center gap-[40px] mt-7 pb-[68px] ">
          ...
          <div className="flex flex-column flex-wrap gap-8">
            ...
            <p className="leading-7 text-[22px]">
              ...
              чтобы стать частью этой уникальной атмосферы и сыграйте пару
              игр в  Мафию. После нескольких месяцев непрерывного роста клуб
              приобрел постоянных игроков, ставших своеобразной «семьей» для
              этого уютного комьюнити.
            </p>
            <p id="about" className="leading-7 text-[22px]">
              ...
              Здесь завязывались дружеские отношения,л юди возвращаються сюда снова и снова, потому
              что они чувствовуют, что здесь они настоящие, что здесь они могут
              быть сами себя.
            </p>
            <p className="leading-7 text-[22px]">
              Со временем, Клуб
              ...
              в интригующую интелектуальную игру, встретиться с друзьями и отдохнуть
              после тяжелого дня работа.
            </p>
            <p className="leading-7 text-[22px]">
              Сегодня, Клуб
              <span className="mx-2">
              ...
              не просто игра, а комьюнити, где можно
              забыться на несколько часов и погрузитесь в атмосферу
              непредсказуемих интриг и захватывающихъ историй.
            </p>
          </div>
        </section>
      </MaxWidthWrapper>
